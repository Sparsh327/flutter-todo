import 'notifier/work_today_notifier.dart';
...
class WorkTodayScreen extends ConsumerStatefulWidget {
  const WorkTodayScreen({Key? key}) : super(key: key);

  @override
  WorkTodayScreenState createState() => WorkTodayScreenState();
}

class WorkTodayScreenState extends ConsumerState<WorkTodayScreen> {
  @override
